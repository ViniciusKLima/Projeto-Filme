...
class DetalhesFilmeController extends AbstractActionController
{
    ...
    public function __construct()
    {
        $this->filmes = [
            ...
            [
                ...
                'capaFundo' => "https://t.ctcdn.com.br/54KHZqjSzhbYDeChIp9RlpWl8-o=/81x215:1263x880/1024x576/smart/i366371.jpeg",
                'anoLancamento' => 1972,
            ...
            [
                ...
                'capaFundo' => "https://wallpapercave.com/wp/wp4119586.jpg",
                'anoLancamento' => 2003,
            ...
            [
                ...
                'capaFundo' => "https://substackcdn.com/image/fetch/$s_!6hd2!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fbucketeer-e05bbc84-baa3-437e-9518-adb32be77984.s3.amazonaws.com%2Fpublic%2Fimages%2F67497347-267d-42f0-b886-24f8fb148e2d_1600x900.jpeg",
                'anoLancamento' => 1974,
                'diretor' => "Francis Ford Coppola",
            ...
            [
                ...
                'capaFundo' => "https://m.media-amazon.com/images/M/MV5BMjA5ODU3NTI0Ml5BMl5BanBnXkFtZTcwODczMTk2Mw@@._V1_QL75_UX513_.jpg",
                'anoLancamento' => 2008,
            ...
            [
                ...
                'capaFundo' => "https://statcdn.fandango.com/MPX/image/NBCU_Fandango/909/98/thumb_F217C17A-3384-4B24-82F8-4305A4224AB0.jpg",
                'anoLancamento' => 2001,
                'diretor' => "Peter Jackson",
            ...
            [
                ...
                'capaFundo' => "https://www.cinematheque.qc.ca/cdn-cgi/image/format=auto/workspace/uploads/projections/_oct6_good_bad_ugly_ennio4banner-fr-1701976321.jpg",
                'anoLancamento' => 1966,
            ...
            [
                ...
                'capaFundo' => "https://www.cinematheque.qc.ca/workspace/uploads/projections/the-lord-of-the-rings-the-two-towers-2-fr-1748288473.jpg",
                'anoLancamento' => 2002,
                'diretor' => "Peter Jackson",
    ...
    public function detalhesAction()
    {
        ...
        if (!$filme) return $this->redirect()->toRoute('home');
